...
export type TaskExpandMode='collapsed'|'expanded'|'remember'
export interface ProjectViewSettings {sortMode:'manual'|'title'|'updated';theme:ProjectTheme;expandMode:TaskExpandMode;expandDepth:number;showSubprojects:boolean;expandedTaskIds:string[]}
