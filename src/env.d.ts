...
declare global { interface Window { bearTodo?: {
  ...
  listTasks():Promise<Task[]>; createTask(title:string,listId?:string,parentId?:string|null):Promise<Task>; saveTask(task:Task,expectedRevision:number):Promise<Task>
